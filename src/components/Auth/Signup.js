...
const SignUp = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-pink-50 to-pink-100 dark:from-gray-900 dark:to-pink-900">
      {/* Header/Logo */}
      ...
      <div className="flex-grow flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl w-full max-w-md overflow-hidden transform transition-all border border-pink-100 dark:border-pink-900">
          ...
          <div className="bg-pink-600 p-6">
            ...
            <p className="text-pink-100 text-center mt-2">Join RedmiNotes today</p>
          </div>
          ...
          <div className="p-6 sm:p-8">
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600 dark:text-gray-400">
                ...
                <Link to="/signin" className="font-medium text-pink-600 dark:text-pink-400 hover:text-pink-500 hover:underline">
                  Sign in
                </Link>
              </p>
            </div>
            ...
            <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
              <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3 text-center">Join RedmiNotes and get</h3>
              <div className="space-y-2">
                <div className="flex items-center">
                  ...
                  <span className="ml-2 text-sm text-gray-600 dark:text-gray-400">Unlimited notes storage</span>
                </div>
                <div className="flex items-center">
                  <svg className="h-5 w-5 text-pink-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="ml-2 text-sm text-gray-600 dark:text-gray-400">Access from any device</span>
                </div>
                <div className="flex items-center">
                  <svg className="h-5 w-5 text-pink-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="ml-2 text-sm text-gray-600 dark:text-gray-400">Secure & private notes</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Footer */}
      <div className="py-4 text-center text-xs text-gray-500 dark:text-pink-200">
